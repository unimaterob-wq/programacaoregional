...
while True:
   ...
   # START 2
    ...
    # drive_base.turn(5)
     att_right_motor.run_angle(400,200)
...
# START 6
    if hub.buttons.pressed()=={Button.RIGHT} and color_sensor.color() == Color.WHITE:
      ...
      drive_base.straight(94.5)
      drive_base.settings(600,500)
      drive_base.straight(94.5)
     # att_right_motor.run_angle(800,100)
      wait(500)
      #att_right_motor.run_angle(400,80)
...
# START 7
    ...
    if hub.buttons.pressed()=={Button.RIGHT} and color_sensor.color() == Color.GREEN:
        ...
        # att_right_motor.run_angle(9000,190)
         ...
         att_right_motor.run_angle(10000,300)
         att_right_motor.run_angle(-10000,300)
         wait(400)
         att_right_motor.run_angle(10000,300)
         att_right_motor.run_angle(-10000,300)
  ...
  #start 5
    if hub.buttons.pressed()=={Button.LEFT}and color_sensor.color() == Color.YELLOW:
       ...
       drive_base.straight(420, wait=False)
      ...
      # drive_base.straight(200)
       ...
       wait(700)
       att_left_motor.run_time(9000,1900)
       wait(500)
       att_right_motor.run_angle(-950,410)
       wait(500)
       #drive_base.straight(25)
       att_left_motor.run_time(-1000,2400)
       wait(500)
