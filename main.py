...
#START 1
    if hub.buttons.pressed()==({Button.RIGHT} or {Button.LEFT})and color_sensor.color() == Color.YELLOW:
     ...
     curva(-85,0.5,0.0002)
     drive_base.settings(500,400)
     drive_base.straight(-331)
     drive_base.use_gyro(False)
     hub.imu.reset_heading(0)
     drive_base.use_gyro(True)
     curva(84.5,0.3,0.0002)
     drive_base.straight(-7)
     att_right_motor.run_angle(-500,390)
     att_left_motor.run_time(400,850)
...
#START 5
    ...
    #  att_left_motor.run_angle(700,150)
     ...
     # curva(180,0.9,0.0004)
      ...
      hub.imu.reset_heading(0)
      drive_base.use_gyro(True)
      curva(125,0.3,0.0002)
      drive_base.straight(250)
      #curva(199.1,0.3,0.0002)
      #drive_base.straight(150)
      att_right_motor.run_time(800,1300)
      att_right_motor.run_time(-800,1300)
...
# START 6
    if hub.buttons.pressed()=={Button.RIGHT} and color_sensor.color() == Color.WHITE:
      ...
      att_right_motor.run_angle(800,-696,wait=False)
      att_left_motor.run_angle(800,-100)
      wait(500)
